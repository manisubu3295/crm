...
import { Loader2, BarChart2, Users, Zap, Eye, EyeOff } from "lucide-react";
import { useAuth } from "../lib/auth.js";
import { Button } from "../components/ui/button.js";
import { Input } from "../components/ui/input.js";

const TENANT_ID = "marcellotech";
...
export function LoginPage() {
  ...
  const onSubmit = async (data: FormData) => {
    setLoading(true);
    try {
      await login(TENANT_ID, data.username, data.password);
      navigate("/");
    } catch (err) {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[420px] flex-col justify-between bg-slate-900 p-10 shrink-0">
        ...
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-green-600 to-emerald-500 shadow-lg shadow-green-700/30">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
            </svg>
          </div>
          <div>
            <p className="text-[15px] font-bold text-white tracking-tight">Marcellotech CRM</p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-3 text-sm text-slate-400 leading-relaxed">
              The all-in-one CRM designed for Marcellotech — track every lead, automate follow-ups, and close more admissions.
            </p>
          </div>
        ...
        <p className="text-[11px] text-slate-600">© 2026 Marcellotech</p>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-background p-6">
        <div className="w-full max-w-[380px]">
          ...
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-green-600 to-emerald-500">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
            </div>
            <div>
              <p className="text-[14px] font-bold text-foreground">Marcellotech CRM</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button
              type="submit"
              className="mt-2 w-full bg-green-700 hover:bg-green-800 text-white shadow-sm shadow-green-700/20"
              disabled={loading}
            >
